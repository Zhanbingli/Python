...
def all_diophantine_solutions(
    ...
    """
    Return up to `n` integer solutions (x, y) to the linear
    Diophantine equation a*x + b*y = c using the extended
    Euclidean algorithm.
    ...
    Time complexity
    ---------------
    O(log(max(|a|, |b|))) to compute a base solution via extended_gcd,
